  ...
  return (
    <Dialog open={open} onClose={onClose} fullScreen
      ...
      <DialogTitle sx={{
        ...
        <IconButton aria-label="Cerrar" onClick={onClose} size="small" sx={{ color: COLORES.textoSuave }}>
          <X size={18} />
        </IconButton>
      </DialogTitle>
      <DialogContent sx={{ p: 0, display: "flex", flexDirection: "column", flex: 1, bgcolor: COLORES.textoMuted }}>
      ...
      <DialogActions sx={{
        ...
        <Button onClick={onClose}
          sx={{ borderRadius: "10px", textTransform: "none", fontSize: 13, color: COLORES.textoTerciario }}>
          Cerrar
        </Button>
