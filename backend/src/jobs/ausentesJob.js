...
const { marcarAusentes } = require('../services/ausenteService');
...
async function marcarAusentesDeFecha(fechaStr) {
  try {
    ...
    console.error('[cron-ausentes] Error general:', err.message);
  }
}

function iniciarAusentesJob() {
  const patron = '45 23 * * *';
...
module.exports = { iniciarAusentesJob };
