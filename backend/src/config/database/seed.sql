...
-- document_details
-- ---------------------------------------------------------------------
INSERT INTO document_details (document_type_id, document_number, issue_date, place_of_issue)
VALUES
    ((SELECT id FROM document_types WHERE name = 'Cédula de Ciudadanía'), '1065432187', '2012-03-15', 'Valledupar'),
    ((SELECT id FROM document_types WHERE name = 'Cédula de Ciudadanía'), '1073654298', '2015-07-22', 'Valledupar'),
    ((SELECT id FROM document_types WHERE name = 'Cédula de Ciudadanía'), '1098765432', '2010-01-10', 'Bogotá'),
    ((SELECT id FROM document_types WHERE name = 'Cédula de Extranjería'), 'CE897654', '2018-05-30', 'Barranquilla')
...
INSERT INTO users (
    ...
    (
        (SELECT id FROM document_details WHERE document_number = 'CE897654'),
